...
def render_lsd(lsd: dict, output_stem: Path) -> dict[str, str]:
    ...
    figure, axis = plt.subplots(figsize=(3.5, 1.4))
    ...
    axis.set_xlabel("Number of notes", fontsize=8.5, labelpad=5)
    axis.set_ylabel("LSD (dB)", fontsize=8.5)
    axis.tick_params(labelsize=8.5, length=2.0, pad=1.2)
    ...
    figure.subplots_adjust(left=0.16, right=0.69, bottom=0.29, top=0.98)
