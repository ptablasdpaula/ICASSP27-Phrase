"""Registered fitter copied for objective injection in the full recovery study.
...
def fit(
    ...
    *,
    ...
    objective = objective if objective is not None else build_loss(canonical_name, target_audio)
