...
def test_paper_loss_labels_resolve_to_six_distinct_losses() -> None:
    assert LOSS_LABELS == ("L_1", "L_2", "MSS", "SOT", "TFW_2", "BiCuL")
    assert len({canonical_loss_name(name) for name in LOSS_LABELS}) == 6


@pytest.mark.parametrize("name", ("L_1", "L_2", "MSS", "SOT", "TFW_2", "BiCuL"))
